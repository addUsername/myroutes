	...
	*/
	...
	<div id='header' class='header'>
		<ul class="selector">
			...
			<li class="search"><input type="date" name="date" id="enddate" value=""/></li>
			<li class="search"><input type="date" name="date2" id="madedate" value=""/></li>
			<li class="search"> 
	...
	function doSave(e){
		...
		var prom = new Promise(function(resolve, reject) {
			...
			var json = window.backend.Handler.Save("haloo")
			if (json) {
			  	//console.log("stuff worked")
				resolve(json);
			}  else {
